...
contract MLDSA_Decode_Test is Test {
    ...
    function test_decode_public_key_sets_rho_from_last_32_bytes() public {
        ...
        bytes32 rho = hex"0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f";
        ...
        MLDSA65_Verifier_v2.DecodedPublicKey memory dpk = harness.exposedDecodePublicKey(raw);
    ...
    function test_decode_signature_sets_c_from_last_32_bytes() public {
        ...
        bytes32 c = hex"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
        ...
        MLDSA65_Verifier_v2.DecodedSignature memory dsig = harness.exposedDecodeSignature(raw);
